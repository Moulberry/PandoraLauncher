...
pub struct MetadataManagerStates {
    ...
    pub(super) legacy_fabric_loader_manifest: MetaLoadStateWrapper<FabricLoaderManifest>,
    ...
    pub(super) legacy_fabric_launch: HashMap<(Ustr, Ustr), MetaLoadStateWrapper<FabricLaunch>>,
...
pub struct MetadataManager {
    ...
    pub(super) legacy_fabric_loader_manifest_cache: Arc<Path>,
...
impl MetadataManager {
    pub fn new(http_client: reqwest::Client, directory: Arc<Path>) -> Self {
        Self {
            ...
            legacy_fabric_loader_manifest_cache: directory.join("legacy_fabric_loader_manifest.json").into(),
