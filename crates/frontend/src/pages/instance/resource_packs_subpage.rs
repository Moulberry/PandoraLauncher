...
use crate::{
    ...
    png_render_cache, root, ts, ui::PageType,
};
...
impl Render for InstanceResourcePacksSubpage {
    fn render(&mut self, _window: &mut gpui::Window, cx: &mut gpui::Context<Self>) -> impl gpui::IntoElement {
        ...
        let header = h_flex()
            ...
            .child(
                Button::new("update")
                    .label(ts!("instance.content.update.check.label"))
                    .success()
                    .compact()
                    .small()
                    .on_click({
            ...
            .child(
                Button::new("addmr")
                    .label(ts!("instance.content.install.from_modrinth"))
                    .success()
                    .compact()
                    .small()
                    .on_click({
            ...
            .child(
                Button::new("addfile")
                    .label(ts!("instance.content.install.from_file"))
                    .success()
                    .compact()
                    .small()
                    .on_click({
