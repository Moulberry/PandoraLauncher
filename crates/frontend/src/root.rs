...
use gpui::{prelude::*, *};
use gpui_component::{Root, breadcrumb::Breadcrumb, scroll::ScrollableElement, v_flex};
...
pub fn switch_page(page: PageType, breadcrumb: Option<Box<dyn Fn() -> Breadcrumb>>, window: &mut Window, cx: &mut App) {
