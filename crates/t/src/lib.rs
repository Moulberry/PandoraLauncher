        ...
        pub mod install {
            ...
            pub mod datapack {
                ...
                pub mod select_world {
                    pub fn get(key: &str) -> Option<&'static str> {
                        match key {
                            "prime_for_next" => Some(prime_for_next()),
                            "title" => Some(title()),
                            _ => None,
                        }
                    }
                    pub fn prime_for_next() -> &'static str {
                        match crate::LANG.load(std::sync::atomic::Ordering::Relaxed) {
                            1 => "Standard für zukünftige verwenden",
                            2 => "Alapértelmezett használata a jövőben",
                            _ => "Use default for future",
                        }
                    }
                    pub fn title() -> &'static str {
                        match crate::LANG.load(std::sync::atomic::Ordering::Relaxed) {
                            1 => "Welt auswählen",
                            2 => "Világ kiválasztása",
                            _ => "Select World",
                        }
                    }
                }
    ...
    pub mod delete {
        pub fn get(key: &str) -> Option<&'static str> {
            match key {
                ...
                "skip_skin_delete_confirmation" => Some(skip_skin_delete_confirmation()),
                "title" => Some(title()),
                _ => None,
            }
        }
        ...
        pub fn skip_skin_delete_confirmation() -> &'static str {
            match crate::LANG.load(std::sync::atomic::Ordering::Relaxed) {
                1 => "Shift+Klick um Skin-Löschungsbestätigung zu überspringen",
                2 => "Shift+Katt a skin törlésének megerősítésének az átlépéséhez",
                _ => "Shift+Click to skip skin delete confirmation",
            }
        }
        pub fn title() -> &'static str {
            match crate::LANG.load(std::sync::atomic::Ordering::Relaxed) {
